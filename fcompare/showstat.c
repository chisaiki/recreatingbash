...
/****************************************************************************/
char* mode2str( int mode) //gets user access permissions of the files
{
...
/****************************************************************************/
char* uid2name ( uid_t uid ) //gets user name using user-id 
{
...
/*--------------------------------------------------------------------------*/
char* gid2name ( gid_t gid ) //get group name
{
